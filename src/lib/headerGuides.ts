...
const headerGuides: HeaderGuideRegistry = {
  ...
  'permissions-policy': {
    ...
    fixSteps: [
      ...
      'Lock down high-risk primitives (camera, microphone, geolocation, USB, serial, payment, interest-cohort, Bluetooth) with feature=().',
  ...
  'cross-origin-resource-policy': {
    ...
    recommendedValue: 'same-origin',
    fixSteps: [
      'Pick the narrowest scope: default to same-origin and only loosen to same-site if subdomains require access.',
